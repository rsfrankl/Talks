...
date: 2024-11-22
description: 2024 Distinguished Getis Lecture in Spatial Analysis, San Diego State University
format: 
  revealjs:
    theme: [default, style.scss]
    center: true
    footer: "Distinguished Getis Lecture in Spatial Analysis | Franklin | November 22, 2024"
...
# A talk in two parts, four chapters in all {.center}
...
# A spaceless *Y* is standard fare <br> In nearly every college lair. {.center}

::: {style="text-align: center"}
--Art Getis, February 23, 1999 at the Ojai Valley Inn and Spa
:::
...
## Geographers have methods for this!
...
# That *space* is central to our success <br> Do not flag or accept recess. {.center}
...
Building data infrastructure for others
...
Building social infrastructure, for others (and ourselves)

# 

![](images/SAD_team.png){fig-align="center"}

## The big idea

"We do something a little different every time, but there’s always a healthy dose of all things geography, life, geography life, and data."

# 

![](images/SAD.png){fig-align="center" width="60%"}

# 

![](images/GLAD.png){fig-align="center"}

# Epilogue

Lessons I've learned (so far)

## 1. No one gets anywhere alone {.center}

## 2. There's a niche for everyone

Or there can be, but depends on community

And there are lots of kinds of career trajectories

## 3. There are lots of ways to do *spatial*

Diversity is a good thing

## 4. "Glue" is indispensable

It also takes a lot of time investment

(I have equivocal feelings about that)

## 5. Discipline matters

(More mixed feelings)\
\
Is there a "we" to what we do? Does it matter?

# 

![Art Getis (and me)](images/art.png){fig-align="center" width="60%"}
...
![](images/art_poem.png){fig-align="center" width="50%"}
